...
class EdidSources::ElectionsCanadaTest < ActiveSupport::TestCase
  test "should return empty when no results are found" do
    ...
    assert_equal [], EdidSources::ElectionsCanada.edid_for("H0H0H0")
  end
  ...
  test "should return nil when more than 1 possibility exists" do
    ...
    assert_equal ["multiple", "http://www.elections.ca/scripts/pss/FindED.aspx?PC=T5S2B9&image.x=0&image.y=0"], EdidSources::ElectionsCanada.edid_for("T5S2B9")
  end
end
